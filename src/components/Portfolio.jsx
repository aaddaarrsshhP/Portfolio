...
export const Portfolio = () => {
  return (
    <>
        ...
        <h1 className="skill-top" style={{display: 'flex', justifyContent: 'center'}}>My Skills</h1>
         ...
         <div style={{padding: '15px 0px 5px 0px'}}>
           ...
           <div className='skills-outer-container'>
               <div className='skills-container'>
                  <div className='skills-image'>
                    <img src='https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/nextjs-icon.svg'/>
                  </div>
                  <h4>next js</h4>
               </div>
             </div>
         ...
         <div  style={{display: 'flex',flexDirection: 'column',alignItems: 'center',columnGap: '4rem',marginTop: '2.5rem',flexWrap: 'wrap',rowGap: '4rem'}}>
            ...
            <div  className='project-container' style={{display: 'flex',flexDirection: 'column',alignItems: 'center'}}>
              ...
              <p className='pro-detail'>You are currently on the website itself.</p>
      ...
      <p style={{marginTop: '70px',marginBottom: '30px'}}> Managed a dynamic to-do list and several mini-projects as a front-end developer, focusing on creating responsive and user-friendly web interfaces. 
